...
import { useSessionSetupContainer } from "@/hooks";
...
const MODES = [
  {
    ...
    description:
      "Practice Parts 1–3 with simulated exam conditions and official band score feedback.",
    accentColor: "violet",
  ...
  },
  {
    ...
    description:
      "Rehearse interviews, presentations, and team standups to master executive communication.",
    accentColor: "blue",
  ...
  },
  {
    ...
    description:
      "Build fluency through natural conversations about travel, culture, hobbies, and daily life.",
    accentColor: "emerald",
...
export default function SessionSetupContainer({
  ...
  const {
    ...
    isFormValid,
    handleStart,
  } = useSessionSetupContainer({ onStartSession });
    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 py-10 md:py-16 animate-fade-in">
      ...
      <div className="text-center mb-14">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(262 88% 68% / 0.10) 0%, transparent 70%)",
            filter: "blur(40px)",
          }}
          aria-hidden="true"
        />
        ...
        <p className="text-muted-foreground text-lg md:text-xl max-w-xl mx-auto font-sans leading-relaxed">
          Your real-time AI conversation partner for IELTS, Business, and
      ...
      <form onSubmit={handleStart} className="space-y-8">
        ...
        <section aria-labelledby="mode-heading" className="space-y-5">
          <div className="flex items-center gap-3">
            ...
            <h2
              id="mode-heading"
              className="text-lg font-bold font-outfit text-foreground"
            >
            ...
            {MODES.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Badge */}
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border mb-3 ${m.badgeColor}`}
                  >
                    {m.badge}
                  </span>

                  <h3 className="text-base font-bold font-outfit mb-2 text-foreground">
                    {m.label}
                  </h3>
              ...
              {mode === "ielts" && (
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="ielts-part-1">
                        Part 1 — Introduction & Familiar Topics
                      </SelectItem>
                      <SelectItem value="ielts-part-2">
                        Part 2 — Individual Long Turn (Cue Card)
                      </SelectItem>
                      <SelectItem value="ielts-part-3">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    {scenario === "ielts-part-1" &&
                      "💬 The examiner will ask questions about yourself, hobbies, and your home."}
                    {scenario === "ielts-part-2" &&
                      "🗣️ You will be given a cue card prompt to speak about for 1–2 minutes."}
                    {scenario === "ielts-part-3" &&
                      "🧠 Abstract, thematic questions linked to your Part 2 topic."}
                  </p>
                </div>
              )}
              ...
              {mode === "business" && (
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="job-interview">
                        💼 Job Interview — Hiring Manager Roleplay
                      </SelectItem>
                      <SelectItem value="client-presentation">
                        📊 Client Presentation — Pitching & Q&A
                      </SelectItem>
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    {scenario === "job-interview" &&
                      "✨ Practice selling your skills and answering behavioral interview questions."}
                    {scenario === "client-presentation" &&
                      "✨ Practice defending your project plan or addressing tough client objections."}
                    {scenario === "team-meeting" &&
                      "✨ Practice presenting your tasks, collaborating, and expressing status clearly."}
                  </p>
                </div>
              )}
              ...
              {mode === "casual" && (
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="general-chitchat">
                        ☀️ General Daily Chit-Chat
                      </SelectItem>
                      <SelectItem value="traveling">
                        ✈️ Travel & Tourism Plans
                      </SelectItem>
                      <SelectItem value="movies-and-books">
                        🎬 Movies, Books & Culture
                      </SelectItem>
                      <SelectItem value="hobbies-and-sports">
                        ⚽ Hobbies, Fitness & Sports
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    ✨ Practice describing casual experiences, sharing opinions,
        ...
        <section aria-labelledby="settings-heading" className="space-y-5">
          ...
          <div className="glass rounded-2xl border border-border/50 p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                🔒 Stored only in your browser's local storage. Never shared or
                logged.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              {selectedVoice && (
                <p className="text-xs text-muted-foreground">
                  {selectedVoice.flag} {selectedVoice.label} speaks in a natural{" "}
                  {selectedVoice.accent} accent, powered by Edge TTS.
                </p>
              )}
            </div>
          </div>
        ...
        {errorMsg && (
          <Alert
            variant="destructive"
            className="animate-shake rounded-xl border-destructive/40 bg-destructive/5"
          >
